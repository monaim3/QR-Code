...
export default function SmartQRPlanSelection() {
  ...
  return (
    <div
      className="min-h-screen bg-[var(--Generator-Background)] flex items-center justify-center"
        ...
        <div className="desktop:w-[1079px]">
          <main className="w-full max-w-7xl py-[10px] flex flex-col justify-center">
            ...
            <div className="pt-[0px] pb-[136px] desktop:pb-[160px]">
              <div
                className="w-full max-w-[1079px] flex flex-col desktop:flex-row items-center desktop:items-start justify-center desktop:justify-between 
                ...
                <div className="w-full flex flex-col items-center desktop:items-start">
                  ...
                  <div className="space-y-[16px] pt-[24px] desktop:pt-[32px] w-full">
                    {plans.map((plan) => (
                      <div
                        key={plan.id}
                        className={`relative w-full ${plan.popular ? "h-auto" : "h-auto"}`}
                      >
                        <button
                        ...
                        >
                          ...
                          {/* Button content */}
                          <div
                            className={`flex items-center justify-between px-[14px] pb-[22px] ${plan.popular ? "pt-[46px]" : "py-[22px]"}`}
                          >
                            {/* Left */}
                            ...
                            ${selectedPlan === plan.id ? "bg-[var(--Blue)]" : "border-[2px] border-gray-300"}`}
                              ...
                              <span className="text-[18px] leading-[28px] font-medium text-[var(--Black)] ">
                                {plan.name}
                              </span>
                            </div>
                  ...
                  <button
                    ...
                    className="hidden md:block w-full h-[48px] bg-[var(--Blue)] hover:bg-[var(--Blue-hover)] text-white text-[18px] leading-[26px] font-medium rounded-[10px] transition-all duration-300 mt-[32px]"
                  >
                    Continue
                  </button>
                  ...
                  <div className="hidden md:block pt-[32px] flex flex-col overflow-auto w-full">
                    {features.map((feature, index) => (
                      <div
                        key={index}
                        className="flex items-center gap-[16px] h-[24px] mb-[12px]"
                      >
