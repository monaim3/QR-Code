  ...
  return (
    ...
    >
      ...
      "
        ...
        <div
          className={`hidden desktop:flex rounded-[10px] items-center justify-center h-[48px] w-full h-[1px] ${plan.popular ? "bg-[var(--Blue)] hover:bg-[var(--Blue-hover)]" : "outline outline-1 outline-[var(--Blue)]"} transition duration-300 my-[24px]`}
        >
          <p
