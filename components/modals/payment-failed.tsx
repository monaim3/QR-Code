      ...
      <div className="relative">
        ...
        <div className="bg-[var(--Generator-Background)] rounded-[8px] p-4 mt-6">
          <p className="text-[var(--Black)] text-[16px] leading-[24px] font-regular">
            Your account expired on <span className="font-semibold">May 29, 2024</span>, your account will be downgraded and the following features will be restricted:
          </p>
        ...
        <div className="text-center mt-6">
          ...
          <div className="hidden desktop:flex h-[40px] w-[210px] flex items-center justify-center rounded-[8px] bg-[#4981FF] hover:bg-[#6FA0FF] transition-colors duration-300 gap-2 mt-6">
            <CrownOutline />
