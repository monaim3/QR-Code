const FourCorner = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      ...
      viewBox="0 0 224 224"
      fill="none"
      {...props} // optional, for passing extra props
    >
      ...
      <path d="M222 2H197.685" stroke="#0A0909" strokeWidth="4" strokeLinecap="round" />
      <path d="M222 197.957V222" stroke="#0A0909" strokeWidth="4" strokeLinecap="round" />
      <path d="M222 222H197.685" stroke="#0A0909" strokeWidth="4" strokeLinecap="round" />
    </svg>
  );
};
