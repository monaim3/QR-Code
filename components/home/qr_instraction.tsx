...
export default function QrInstraction() {
 return (
    <main className="flex flex-col gap-4 items-center justify-center min-w-screen px-[50px] py-[160px]">
      <h1 className="text-4xl font-bold text-center">
      <span className="text-gray-900">How to create your custom QR code?</span>
      </h1>
      <h3 className="text-1.5xl font-regular text-center px-3">
        <span className="text-gray-900">Turn ordinary links into powerful visual connections</span>
      </h3>
      <div className="flex flex-row flex-wrap gap-8 pt-[80px] pb-12 justify-center">
        <StepCard
...
function StepCard({ imagePath, title, subtitle1, subtitle2 }: { imagePath: string; title: string; subtitle1: string; subtitle2 : string }) {
  return (
    <div className="flex flex-col items-center">
      ...
      <span className="text-base text-center text-gray-600 pt-2">{subtitle1}</span>
