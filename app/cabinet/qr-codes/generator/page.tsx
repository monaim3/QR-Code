...
export default function DashboardGenerator() {
  ...
  const qrTypes = [
    ...
    },
    {
      ...
      href: "/cabinet/qr-codes/generator/vcard",
      icon: <VcardQr />,
    ...
    },
    {
      ...
      description: t(
        "generator__step_1__qr_type_cards__pdf__description__changed",
      ),
      href: "/cabinet/qr-codes/generator/pdf",
      icon: <PdfQr />,
    ...
    },
    {
      ...
      href: "/cabinet/qr-codes/generator/images",
      icon: <ImagesQr />,
    ...
    },
    {
      ...
      href: "/cabinet/qr-codes/generator/social-media",
      icon: <SocialQr />,
    ...
    },
    {
      ...
      href: "/cabinet/qr-codes/generator/video",
      icon: <VideoQr />,
    ...
    },
    {
      ...
      href: "/cabinet/qr-codes/generator/simple-text",
      icon: <SimpleTextQr />,
    ...
    },
    {
      ...
      href: "/cabinet/qr-codes/generator/business-page",
      icon: <BusinessQr />,
    ...
    },
    {
      ...
      href: "/cabinet/qr-codes/generator/facebook",
      icon: <FacebookQr />,
    ...
    },
    {
      ...
      href: "/cabinet/qr-codes/generator/wifi",
      icon: <WifiQr />,
    ...
    },
    {
      ...
      href: "/cabinet/qr-codes/generator/app",
      icon: <AppQr />,
    ...
    },
    {
      ...
      href: "/cabinet/qr-codes/generator/menu",
      icon: <MenuQr />,
