...
export default function AboutUsLeftelement(){
    return (
        <div className="order-2 desktop:order-1 desktop:flex-1 flex flex-col items-center justify-center desktop:items-start w-full">
            <h1 className="text-[32px] desktop:text-[40px] leading-[40px] leading-[32px] font-bold mb-2">Get to know us</h1>
            <p className="desktop:w-[488px] text-center desktop:text-start text-[18px] leading-[26px] font-regular mb-6">Welcome to Smart QR Code, your go-to QR code generator for your business and personal needs.</p>
            <Link 
            href="#more_about"
