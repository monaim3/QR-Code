      ...
      <div className="flex flex-col items-start justify-center">
        {contactInfo.map((info) => {
          return (
            <div
              key={info.id}
              className="py-6 flex gap-6 items-center justify-center"
            >
              {info.id == 1 ? (
                <Mail className="h-[21px] w-[26px] text-[var(--Blue)] flex-shrink-0" />
              ) : info.id == 2 ? (
                <Phone className="h-[21px] w-[26px] text-[var(--Blue)] flex-shrink-0" />
              ) : (
                <MapPin className="h-[21px] w-[26px] text-[var(--Blue)] flex-shrink-0" />
              )}
