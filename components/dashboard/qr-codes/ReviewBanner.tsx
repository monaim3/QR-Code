...
export default function ReviewBanner() {
  return (
    <div className="flex items-center flex-col tablet:flex-row self-stretch tablet:gap-6 gap-[10px] p-4 rounded-[var(--Corner-Radius-10)] bg-[var(--Purple)] desktopDashboard:my-1 my-0">
