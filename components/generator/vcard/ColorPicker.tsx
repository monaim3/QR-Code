...
export default function ColorPicker({ label, color }: Props) {
  ...
  return (
    <div className="flex flex-col items-start gap-2 p-0 flex-1">
      ...
      <div
        className={`flex h-12 items-center gap-2 self-stretch px-4 py-2 rounded-[var(--Corner-Radius-10)] bg-white border ${isFocused ? "ring-2 ring-[var(--Blue)] border-[var(--Blue)]" : "border-[var(--Boarder-Grey)] hover:ring-2 hover:ring-[var(--Boarder-Grey)]"}`}
      >
        <input
          type="text"
